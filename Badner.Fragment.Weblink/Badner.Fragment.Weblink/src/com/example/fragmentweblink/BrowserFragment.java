    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		_webView.setDownloadListener(new DownloadListener()
		{
					...
					long contentLength)
			{
				...
				{
					//makeInfoNotification(MessagesManager.getTitle($insert_usb_to_download, getResources().getString(R.string.insert_usb_to_download)));
				}
				else
				{
//					Intent intent = new Intent(WebActivity.this, DownloadChooseActivity.class);
...
//				final boolean isExternalStorageConnected = getExternalStorageController().isExtStorage();
//				
...
//						if(!isExternalStorageConnected)
//						{
//							//makeInfoNotification(MessagesManager.getTitle($insert_usb_to_upload, getResources().getString(R.string.insert_usb_to_upload)));
//							mUploadMessage.onReceiveValue(null);
//							return;
//						}
//						
////						Intent intent = new Intent(WebActivity.this, UploadChooserActivity.class);
...
//				});
		...
		final ImageButton fullscreenImageView = (ImageButton) view.findViewById(R.id.web_full_screen_image_view);
		fullscreenImageView.setOnClickListener(new OnClickListener()
		{
			@Override
			public void onClick(View v)
			{
				_isHideBars = !_isHideBars;
